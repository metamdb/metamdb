    ...
    <div className="datenschutz">
      <div className="content">
        <div className="container">
          ...
          <p>Stand: 28. Mai 2021</p>
          <h2>Inhaltsübersicht</h2>
          <ul className="index">
            <li>
              <a className="index-link" href="#introduction">
                Einleitung
              </a>
            </li>
            <li>
              <a className="index-link" href="#contact-person">
                Verantwortlicher
              </a>
            </li>
            <li>
              <a className="index-link" href="#overview">
                Übersicht der Verarbeitungen
              </a>
            </li>
            <li>
              <a className="index-link" href="#legal">
                Maßgebliche Rechtsgrundlagen
              </a>
            </li>
            <li>
              <a className="index-link" href="#security">
                Sicherheitsmaßnahmen
              </a>
            </li>
            <li>
              <a className="index-link" href="#cookies">
                Einsatz von Cookies
              </a>
            </li>
            <li>
            ...
            <li>
              <a className="index-link" href="#data-deletion">
                Löschung von Daten
              </a>
            </li>
            <li>
              <a className="index-link" href="#privacy-updates">
                Änderung und Aktualisierung der Datenschutzerklärung
              </a>
            </li>
            <li>
              <a className="index-link" href="#rights">
                Rechte der betroffenen Personen
              </a>
            </li>
            <li>
              <a className="index-link" href="#definitions">
                Begriffsdefinitionen
              </a>
            </li>
          </ul>
          <h2 id="contact-person">Verantwortlicher</h2>
          <p>
            ...
            <br />
            Rebenring 56
            <br /> D-38106 Braunschweig
            <br />
            Germany
          </p>
          <p>E-Mail-Adresse: c.starke@tu-bs.de.</p>
          <h2 id="overview">Übersicht der Verarbeitungen</h2>
          <p>
          ...
          <h3 id="legal">Maßgebliche Rechtsgrundlagen</h3>
          <p>
          ...
          <h2 id="cookies">Einsatz von Cookies</h2>
          <p>
          ...
          <h2 id="contact">Kontaktaufnahme</h2>
          <p>
          ...
          <ul class="m-elements">
            ...
            <li>
              ...
              Browser der Nutzer verwendet werden. Die Einbindung erfolgt auf
          ...
          <h2 id="data-deletion">Löschung von Daten</h2>
          <p>
          ...
          <h2 id="rights">Rechte der betroffenen Personen</h2>
          <p>
          ...
          <h2 id="definitions">Begriffsdefinitionen</h2>
          <p>
